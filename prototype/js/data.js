...
const DB = {
  ...
  students: {
    maya: {
      ...
      mood: 'Grateful', moodEmoji: '☼︎',
      clock: { therePlace: 'CHIANG MAI', there: '21:41', homePlace: 'FRANKLIN', home: '09:41' },
      day: 214, of: 270,
    ...
    elijah: {
      ...
      mood: 'Homesick', moodEmoji: '☂︎',
      clock: { therePlace: 'ANTIGUA', there: '08:41', homePlace: 'FRANKLIN', home: '09:41' },
      day: 92, of: 270,
    ...
    sarah: {
      ...
      mood: 'Excited', moodEmoji: '✈︎',
      clock: { therePlace: 'FRANKLIN', there: '09:41', homePlace: 'PRAIA', home: '13:41' },
      countdown: 63,
  ...
  /* ---------- Check-in options ---------- */
  /* Inner-weather glyphs — typographic, never emoji */
  moods: [
    { label: 'Encouraged',  emoji: '✹︎' },
    { label: 'Peaceful',    emoji: '≈︎' },
    { label: 'Grateful',    emoji: '☼︎' },
    { label: 'Excited',     emoji: '✈︎' },
    { label: 'Tired',       emoji: '☾︎' },
    { label: 'Homesick',    emoji: '☂︎' },
    { label: 'Overwhelmed', emoji: '≋︎' },
    { label: 'Need support', emoji: '✚︎' },
  ],
